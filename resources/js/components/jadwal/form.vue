    ...
    <div>
          ...
          <el-form :model="form" ref="berita_form" label-position="top">
            <div class="row">
                ...
                <div class="form-group col-md-3">
                    <el-form-item
                        prop="id_kategori" label="Kategori"
                        :rules="{ required: true, message: 'field tidak boleh kosong', trigger: 'change'}">
                            <el-select v-model="form.id_kategori" clearable placeholder="Pilih Kategori" :disabled="disabled"
                ...
                <div class="form-group col-md-3">
                    <el-form-item label="Sub Kategori">
                        <el-select v-model="form.id_subkategori" clearable placeholder="Pilih  sub Kategori"
            ...
            <div class="row">
              ...
              <div class="col-md-3">
                 <el-form-item label="#hastag" label-width="100%" 
                   prop="tag"
                  :rules="{ required: true, message: 'field tidak boleh kosong', trigger: 'blur' }">
                  <el-col :span="24">
                      <el-select
      ...
      <div class="row">
        <div class="col-md-5">
          ...
          <input type="file" id="file" :disabled="disabled" ref="file" accept="image/*" @change="handleFileUpload()"/>
        </div>
        <div class="col-md-7">
          <el-input
              :disabled="disabled"
      ...
      let tagarray
        axios
            ...
            .then(r => (
              ...
              this.disabled = false,
              this.image.imagePreview = urlBase.urlWeb+'/storage/app/artikel/'+this.form.folder+'/'+this.form.gambar
            ));
    },
    GetKategori(){
        axios
    ...
    GetSubKategori(){
        axios
            ...
            .then(r => (
                ...
                this.subKategori.length === 0 ? this.select.subKategori = 
                true : this.select.subKategori = false, this.form.id_subkategori = null
            ));
    },
    handleFileUpload(){
