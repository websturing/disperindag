    ...
    <div class="card">
        <el-table
            ...
            :data="table.data.filter(data => !table.search || 
              data.kecamatan.toLowerCase().includes(table.search.toLowerCase()) ||
              data.kode.toLowerCase().includes(table.search.toLowerCase())
            )"
            style="width: 100%">
            <el-table-column type="index" width="80"></el-table-column>
            <el-table-column label="kode" prop="kode"></el-table-column>
            <el-table-column label="kecamatan" prop="kecamatan"></el-table-column>
            <el-table-column
                align="right">
